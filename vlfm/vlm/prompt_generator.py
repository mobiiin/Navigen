    ...
    def generate_prompt(self) -> str:
        ...
        if not self.action_history:
            ...
            self.initial_prompt = ''' 
                ...
                Once you find it, move near the couch and stop.
            ...
            # self.initial_prompt = '''
            # You are a robot navigating an indoor environment in search of a couch.
            # Choose the best action to lead to the couch by scoring the actions (choose from: [go forward, go backward, turn right, turn left]), indicating how likely it is to guide the robot toward the couch.
            # When providing your response, use this structure:
            #     - Go forward: [Score]
            #     - Go backward: [Score]
            #     - Turn right: [Score]
            #     - Turn left: [Score]
            # Each score should be a number between 0 and 1. 1 means full confidence that the action will lead to finding the couch. 0 means no confidence. 
            # '''
